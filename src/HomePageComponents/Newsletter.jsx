      ...
      <div className="shadow-xl rounded-lg border p-6 container  xl:w-auto mx-auto flex flex-col md:flex-row  xl:items-stretch justify-between xl:flex-row ">
        ...
        <div className="w-full xl:w-1/2 xl:pl-40 xl:py-28">
          ...
          <div className="flex items-stretch mt-6">
            ...
            />
            <button className="w-32 rounded-l-none hover:bg-green-800 bg-green-600 rounded text-base font-medium leading-none text-white p-5 uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700">
              subscribe
            </button>
          </div>
        </div>
